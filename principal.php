...
<html lang="pt-br">
	...
	<body>
		...
		<footer id="footerPage" class="pt-3 pb-1 mt-5">
			<p class="text-center mb-2">Projeto desenvolvido como Trabalho de Conclusão de Curso de Desenvolvimento Fullstack na PUCRS</p>
			<div class="text-center mt-3 mb-1 version">v. 202301</div>
		</footer>
		<script>
